source "vsphere-iso" "this" {
  ...
  boot_command = [
    ...
    "netcfg/get_ipaddress=${var.vm_ip} netcfg/get_netmask=${var.vm_netmask} ",
    "netcfg/get_gateway=${var.vm_gateway} netcfg/get_nameservers=${var.vm_dns} ",
    "netcfg/disable_autoconfig=true netcfg/get_hostname=${var.vm_name} ",
    "netcfg/get_domain=catixs.net fb=false debconf/frontend=noninteractive ",
